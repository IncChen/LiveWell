...
static CGFloat const CYLTabBarControllerHeight = TabBarControllerHeight;
...
- (NSArray *)viewControllers {
    DynamicViewController *firstViewController = [[DynamicViewController alloc] init];
    ...
    EnjoyPictureViewController *thirdViewController = [[EnjoyPictureViewController alloc] init];
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"nav_home",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"nav_home_pre", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"发现",
                                                  CYLTabBarItemImage : @"nav_discovery",
                                                  CYLTabBarItemSelectedImage : @"nav_discovery_pre",
                                                  };
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : @"看图",
                                                 CYLTabBarItemImage : @"nav_gallery",
                                                 CYLTabBarItemSelectedImage : @"nav_gallery_pre",
                                                 };
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"我的",
                                                  CYLTabBarItemImage : @"nav_user",
                                                  CYLTabBarItemSelectedImage : @"nav_user_pre"
                                                  };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    selectedAttrs[NSForegroundColorAttributeName] = App_Theme_Color;
